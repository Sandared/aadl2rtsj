 ...
 */
public class dataLoggerConnectionBroker extends BasicConnectionBroker {

	/**
	 * A logger for logging errors/warnings/etc.
	 */
	private static final Logger log = Logger.getLogger(dataLoggerConnectionBroker.class.getName());
	 ...
	 */
	private DataLoggerimpl component;

	public dataLoggerConnectionBroker(ConnectionBroker parentBroker, DataLoggerimpl component) {
