 ...
 */
public class altitudeControlConnectionBroker extends BasicConnectionBroker {

	/**
	 * A logger for logging errors/warnings/etc.
	 */
	private static final Logger log = Logger.getLogger(altitudeControlConnectionBroker.class.getName());
	 ...
	 */
	private AltitudeControlimpl component;

	public altitudeControlConnectionBroker(ConnectionBroker parentBroker, AltitudeControlimpl component) {
