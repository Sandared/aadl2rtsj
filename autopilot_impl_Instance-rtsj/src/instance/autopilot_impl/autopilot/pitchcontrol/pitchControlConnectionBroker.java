 ...
 */
public class pitchControlConnectionBroker extends BasicConnectionBroker {

	/**
	 * A logger for logging errors/warnings/etc.
	 */
	private static final Logger log = Logger.getLogger(pitchControlConnectionBroker.class.getName());
	 ...
	 */
	private PitchControlimpl component;

	public pitchControlConnectionBroker(ConnectionBroker parentBroker, PitchControlimpl component) {
