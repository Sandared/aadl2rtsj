 ...
 */
public class mixThrottlesControlConnectionBroker extends BasicConnectionBroker {

	/**
	 * A logger for logging errors/warnings/etc.
	 */
	private static final Logger log = Logger.getLogger(mixThrottlesControlConnectionBroker.class.getName());
	 ...
	 */
	private MixThrottlesControlimpl component;

	public mixThrottlesControlConnectionBroker(ConnectionBroker parentBroker, MixThrottlesControlimpl component) {
