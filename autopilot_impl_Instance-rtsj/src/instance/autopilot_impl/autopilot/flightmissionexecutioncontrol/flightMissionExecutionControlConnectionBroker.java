 ...
 */
public class flightMissionExecutionControlConnectionBroker extends BasicConnectionBroker {

	/**
	 * A logger for logging errors/warnings/etc.
	 */
	private static final Logger log = Logger.getLogger(flightMissionExecutionControlConnectionBroker.class.getName());
	 ...
	 */
	private FlightMissionExecutionControlimpl component;

	public flightMissionExecutionControlConnectionBroker(ConnectionBroker parentBroker,
			FlightMissionExecutionControlimpl component) {
