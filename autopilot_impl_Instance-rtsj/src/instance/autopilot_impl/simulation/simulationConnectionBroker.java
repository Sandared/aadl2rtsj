 ...
 */
public class simulationConnectionBroker extends BasicConnectionBroker {

	/**
	 * A logger for logging errors/warnings/etc.
	 */
	private static final Logger log = Logger.getLogger(simulationConnectionBroker.class.getName());
	 ...
	 */
	private x_planeimpl component;

	public simulationConnectionBroker(ConnectionBroker parentBroker, x_planeimpl component) {
