...
/**
 * This interface represents the model element PitchControl</br>
 * Each DATA PORT of PitchControl is represented by a correspong in'dataPortName' or out'dataPortName' method.
 * @author thomas.driessen@informatik.uni-augsburg.de
 */
public interface PitchControl extends BasicController {
	...
	/**
	 * This method is not meant for use, as it got refined by {@link #inCommandIn inCommandIn(CommandPitchCommand data)}</br>
	...
	void inCommandIn(CommandPitchCommand data);
}
