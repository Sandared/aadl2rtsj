...
/**
 * This interface represents the model element RollControl</br>
 * Each DATA PORT of RollControl is represented by a correspong in'dataPortName' or out'dataPortName' method.
 * @author thomas.driessen@informatik.uni-augsburg.de
 */
public interface RollControl extends BasicController {
	...
	/**
	 * This method is not meant for use, as it got refined by {@link #inCommandIn inCommandIn(CommandRollCommand data)}</br>
	...
	void inCommandIn(CommandRollCommand data);
}
