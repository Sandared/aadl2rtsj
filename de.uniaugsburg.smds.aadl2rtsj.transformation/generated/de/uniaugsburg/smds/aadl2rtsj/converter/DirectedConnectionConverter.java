...
public class DirectedConnectionConverter{
  ...
  protected final String TEXT_6 = " value = null;" + NL + "\t" + NL + "\tpublic void putValue(";
  protected final String TEXT_7 = " value){" + NL + "\t\t//TODO: locking?" + NL + "\t\tthis.value = value;" + NL + "\t}" + NL + "\t" + NL + "\tpublic ";
  protected final String TEXT_8 = " getValue(){" + NL + "\t\t//TODO: locking?" + NL + "\t\treturn value;" + NL + "\t}" + NL + "}";
