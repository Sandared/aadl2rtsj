...
public class UtilAdapterFactory extends AdapterFactoryImpl {
	...
	protected UtilSwitch<Adapter> modelSwitch =
		new UtilSwitch<Adapter>() {
			@Override
			public Adapter caseOffsetTime(OffsetTime object) {
				return createOffsetTimeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link util.OffsetTime <em>Offset Time</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOffsetTimeAdapter() {
		return null;
	}
