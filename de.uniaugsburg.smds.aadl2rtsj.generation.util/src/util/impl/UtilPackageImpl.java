...
public class UtilPackageImpl extends EPackageImpl implements UtilPackage {
	 ...
	 * @generated
	 */
	private EClass offsetTimeEClass = null;
	 ...
	 * @generated
	 */
	public EClass getOffsetTime() {
		return offsetTimeEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getOffsetTime_Ms() {
		return (EAttribute)offsetTimeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getOffsetTime_Ns() {
		return (EAttribute)offsetTimeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getOffsetTime_UniqueId() {
		return (EAttribute)offsetTimeEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getOffsetTime_IoTime() {
		return (EAttribute)offsetTimeEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getOffsetTime_Connection() {
		return (EReference)offsetTimeEClass.getEStructuralFeatures().get(4);
	}
	...
	public void createPackageContents() {
		...
		offsetTimeEClass = createEClass(OFFSET_TIME);
		createEAttribute(offsetTimeEClass, OFFSET_TIME__MS);
		createEAttribute(offsetTimeEClass, OFFSET_TIME__NS);
		createEAttribute(offsetTimeEClass, OFFSET_TIME__UNIQUE_ID);
		createEAttribute(offsetTimeEClass, OFFSET_TIME__IO_TIME);
		createEReference(offsetTimeEClass, OFFSET_TIME__CONNECTION);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(offsetTimeEClass, OffsetTime.class, "OffsetTime", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getOffsetTime_Ms(), ecorePackage.getELong(), "ms", null, 0, 1, OffsetTime.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
